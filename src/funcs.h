...
int openfiles(EN_Project *p, char *, char *,
              char *);                          /* Opens input & report files */
...
int findvalve(EN_Network *n, int);
    /* Find valve index from node index */                               // (AH)
...
void writestatchange(EN_Project *pr, int, char,
                     char); /* Writes link status change  */
void writecontrolaction(EN_Project *pr, int,
                        int); /* Writes control action taken*/
void writeruleaction(EN_Project *pr, int,
                     char *);                  /* Writes rule action taken   */
...
void marknodes(EN_Project *pr, int, int *,
               char *); /* Identifies connected nodes */
void getclosedlink(EN_Project *pr, int,
                   char *);                 /* Finds a disconnecting link */
void writelimits(EN_Project *pr, int, int); /* Writes reporting limits    */
int checklimits(report_options_t *rep, double *, int,
                int);                   /* Checks variable limits     */
...
void setlinkstatus(EN_Project *pr, int, char, StatType *,
                   double *); /* Sets link status           */

void setlinksetting(EN_Project *pr, int, double, StatType *,
                    double *); /* Sets pump/valve setting    */
...
StatType cvstatus(EN_Project *pr, StatType, double,
                  double); /* Updates CV status          */
StatType pumpstatus(EN_Project *pr, int, double); /* Updates pump status */
StatType prvstatus(EN_Project *pr, int, StatType, double, double,
                   double); /* Updates PRV status         */

StatType psvstatus(EN_Project *pr, int, StatType, double, double,
                   double); /* Updates PSV status         */

StatType fcvstatus(EN_Project *pr, int, StatType, double,
                   double); /* Updates FCV status         */
...
/*** Updated 10/25/00 ***/
/*** Updated 12/29/00 ***/
void curvecoeff(EN_Project *pr, int, double, double *,
                double *); /* Computes curve coeffs.     */
...
void prvcoeff(EN_Project *pr, int iLink, int n1,
              int n2); /* Computes PRV coeff.        */
void psvcoeff(EN_Project *pr, int iLink, int n1,
              int n2); /* Computes PSV coeff.        */
void fcvcoeff(EN_Project *pr, int iLink, int n1,
              int n2);                      /* Computes FCV coeff.        */
...
void addseg(EN_Project *pr, int, double,
            double);                          /* Adds a WQ segment to pipe  */
...
double pipereact(EN_Project *pr, int, double, double,
                 long); /* Reacts water in a pipe     */
double tankreact(EN_Project *pr, double, double, double,
                 long); /* Reacts water in a tank     */
double bulkrate(EN_Project *pr, double, double,
                double); /* Finds bulk reaction rate   */
double wallrate(EN_Project *pr, double, double, double,
                double); /* Finds wall reaction rate   */
