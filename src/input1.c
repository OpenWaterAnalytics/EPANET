...
Version:      2.2
Module:       input1.c
Description:  initializes, retrieves and adjusts network data from an INP file 
Authors:      see AUTHORS
...
*/
{
    ...
    qual->Qstep = 0;            // No pre-set quality time step
...
*/
{
    ...
    if (qual->Qstep == 0) qual->Qstep = time->Hstep / 10;
    ...
    qual->Qstep = MIN(qual->Qstep, time->Hstep);
