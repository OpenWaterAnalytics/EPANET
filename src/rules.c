...
static void writepremise(Spremise *p, FILE *f, network_t *net);
static void writeaction(Saction *a, FILE *f, network_t *net);
...
void addrule(parser_data_t *parser, char *tok)
//--------------------------------------------------------------
...
void writepremise(Spremise *p, FILE *f, network_t *net)
//-----------------------------------------------------------------------------
...
void writeaction(Saction *a, FILE *f, network_t *net)
//-----------------------------------------------------------------------------
