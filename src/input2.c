...
Version:      2.2
Module:       input2.c
Description:  reads and interprets network data from an INP file
Authors:      see AUTHORS
...
// Exported functions
int addnodeID(network_t *n, int, char *);
int addlinkID(network_t *n, int, char *);
...
int addnodeID(network_t *net, int n, char *id)
/*
**-------------------------------------------------------------
**  Input:   n = node index
**           id = ID label
...
int addlinkID(network_t *net, int n, char *id)
/*
**-------------------------------------------------------------
**  Input:   n = link index
**           id = ID label
...
int addpattern(parser_data_t *parser, char *id)
/*
**-------------------------------------------------------------
...
int addcurve(parser_data_t *parser, char *id)
/*
**-------------------------------------------------------------
