...
*/
{
    ...
    // "n" is the number of pattern multiplier factors contained in the line
    n = parser->Ntokens - 1;
    if (n < 1) return 201;
...
*/
{
    ...
    {
        curve->Capacity += 10;
        curve->X = realloc(curve->X, curve->Capacity * sizeof(double));
        curve->Y = realloc(curve->Y, curve->Capacity * sizeof(double));
    }
