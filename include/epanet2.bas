...
'Nodal Demand Functions
 ...
 Declare Function ENadddemand Lib "epanet2.dll" (ByVal nodeIndex As Long, ByVal baseDemand As Single, ByVal pattern As String, ByVal name As String key As Long) As Long
 Declare Function ENdeletedemand Lib "epanet2.dll" (ByVal nodeIndex As Long, ByVal demandIndex As Long) As Long
 Declare Function ENgetdemandindex Lib "epanet2.dll" (ByVal nodeIndex As Long, ByVal name As String, ByVal key As Long, demandIndex As Long) As Long
