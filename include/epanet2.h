...
int DLLEXPORT EN_getcontrol(EN_ProjectHandle ph, int controlIndex, int *controlType,
        int *linkIndex, EN_API_FLOAT_TYPE *setting, int *nodeIndex, EN_API_FLOAT_TYPE *level);
...
// ADDING AND DELETING NETWORK OBJECTS
/**
